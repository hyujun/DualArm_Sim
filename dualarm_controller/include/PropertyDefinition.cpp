...
//Right hand
		{0, 0, -1,
				...
				0.0, -215.0e-3, 800.0e-3+306e-3},		// 3
		{0, 1, 0,
				0.0, -215.0e-3, 800.0e-3+306e-3,
				0.0, -325.0e-3, 800.0e-3+306e-3},		// 4
		{1, 0, 0,
				0.0, -325.0e-3, 800.0e-3+306e-3,
				0.0, -325.0e-3, 558.0e-3+306e-3},		// 5
		{0, 0, 1,
				0.0, -325.0e-3, 558.0e-3+306e-3,
				-24.5e-3, -325.0e-3, 400.0e-3+306e-3},     // 6
		{0, 1, 0,
				-24.5e-3, -325.0e-3, 400.0e-3+306e-3,
				0.0, -325.0e-3, 245.0e-3+306e-3},		// 7
#if defined(_WITH_HAND_)
		{0, 0, 1,
				0.0, -325.0e-3, 245.0e-3+306e-3,
				0.0, -325.0e-3, 169.5e-3+306e-3},		// 8

		{1, 0, 0,
				0.0, -325.0e-3, 169.5e-3+306e-3,
				0.0, -325.0e-3, 41.3e-3+306e-3},		// Wrist
#else
		{0, 0, 1,
...
//Left hand
		{0, 0, -1,
				0.0, 125.0e-3, 717.0e-3+306e-3,
				0.0, 215.0e-3, 800.0e-3+306e-3},		// 10
		{0, -1, 0,
				0.0, 215.0e-3, 800.0e-3+306e-3,
				0.0, 325.0e-3, 800.0e-3+306e-3},		// 11
		{1, 0, 0,
				0.0, 325.0e-3, 800.0e-3+306e-3,
				0.0, 325.0e-3 ,558.0e-3+306e-3},		// 12
		{0, 0, 1,
				0.0, 325.0e-3, 558.0e-3+306e-3,
				-24.5e-3, 325.0e-3, 400.0e-3+306e-3},	// 13
		{0, -1, 0,
				-24.5e-3, 325.0e-3, 400.0e-3+306e-3,
				0.0, 325.0e-3, 245.0e-3+306e-3},		// 14
#if defined(_WITH_HAND_)
		{0, 0, 1,
				0.0, 325.0e-3, 245.0e-3+306e-3,
				0.0, 325.0e-3, 169.5e-3+306e-3},		// 15
		{1, 0, 0,
				0.0, 325.0e-3, 169.5e-3+306e-3,
				0.0, 325.0e-3, 41.3e-3+306e-3},		// Wrist
#else
