...
public:
    ...
    void SetPIDGain(Eigen::VectorXd & _Kp, Eigen::VectorXd & _Kd, Eigen::VectorXd & _Ki, Eigen::VectorXd &_Hinf);
    ...
    void TaskInvDynController(VectorXd &_dx, VectorXd &_dxdot, VectorXd &_q, VectorXd &_qdot, double *p_Toq, double &_dt);
