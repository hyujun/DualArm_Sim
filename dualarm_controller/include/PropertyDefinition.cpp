...
//Left hand
		{0, 0, -1,
				0.0, 125.0e-3, 717.0e-3+306e-3,
				0.0, 215.0e-3, 800.0e-3+306e-3},		// 9
		{0, -1, 0,
				0.0, 215.0e-3, 800.0e-3+306e-3,
				0.0, 325.0e-3, 800.0e-3+306e-3},		// 10
		{1, 0, 0,
				0.0, 325.0e-3, 800.0e-3+306e-3,
				0.0, 325.0e-3 ,558.0e-3+306e-3},		// 11
		{0, 0, 1,
				0.0, 325.0e-3, 558.0e-3+306e-3,
				-24.5e-3, 325.0e-3, 400.0e-3+306e-3},	// 12
		{0, -1, 0,
				-24.5e-3, 325.0e-3, 400.0e-3+306e-3,
				0.0, 325.0e-3, 245.0e-3+306e-3},		// 13
#if defined(_WITH_HAND_)
		{0, 0, 1,
				0.0, 325.0e-3, 245.0e-3+306e-3,
